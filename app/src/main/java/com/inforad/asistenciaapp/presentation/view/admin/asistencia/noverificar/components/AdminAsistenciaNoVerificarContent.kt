package com.inforad.asistenciaapp.presentation.view.admin.asistencia.noverificar.components
...
@Composable
fun AdminAsistenciaNoVerificarContent(paddingValues: PaddingValues, navController: NavHostController) {
                    ...
                    Card(
                        ...
                        ConstraintLayout(
                            ...
                            Column(
                                ...
                                Text(
                                    text = "La asistencia ya se registró anteriormente",
                                    modifier = Modifier
